          ...
          <Wrapper>
            <WrapperLeft>
              <WrapperLeftTop>
                ...
                <InnerScore>{teams[0].score}</InnerScore>
              </WrapperLeftTop>
              <WrapperLeftBottom>
                ...
                <InnerScore>{teams[1].score}</InnerScore>
              </WrapperLeftBottom>
            </WrapperLeft>
            ...
            <WrapperMiddle>
              <WrapperMiddleTeam>
                <StatusPanelTeam
                  ...
                  abbrSize={1.8}
                />
                <MiddleTeamName>{teams[0].teamName}</MiddleTeamName>
              </WrapperMiddleTeam>
              <WrapperMiddleTeam>
                <StatusPanelTeam
                  teamInfo={teams[1]}
                  ...
                  abbrSize={1.8}
                />
                <MiddleTeamName>{teams[1].teamName}</MiddleTeamName>
              </WrapperMiddleTeam>
            </WrapperMiddle>
...
const WrapperLeftTop = styled.div`
  width: ${props => util.vhToPx(20)};
  height: ${props => util.vhToPx(3)};
  background-color: #cfd2d0;
  border-radius: 0 ${props => util.vhToPx(3)} ${props => util.vhToPx(3)} 0;
  display: flex;
  flex-direction: row;
`
const WrapperLeftTopInnerFront = styled.div`
  ...
  padding-right: ${props => util.vhToPx(1.5)};
  width: 67%;
  height: 100%;
  background-color: ${props => props.backgroundColor || '#565859'};
  border-top-right-radius: ${props => util.vhToPx(3)};
  border-bottom-right-radius: ${props => util.vhToPx(3)};
`
const WrapperLeftTopInnerFrontText = styled.div`
  font-family: pamainregular;
  font-size: ${props => util.vhToPx(2.2)};
  color: #ffffff;
  padding-right: ${props => util.vhToPx(0.5)};
`
const WrapperLeftTopInnerFrontImage = styled.img`
  height: 80%;
  margin-top: ${props => util.vhToPx(0.4)};
  padding-right: ${props => util.vhToPx(0.5)};
`
const InnerScore = styled.div`
  ...
  display: flex;
  justify-content: flex-end;
  padding-right: ${props => util.vhToPx(3)};
`
...
const WrapperRightTop = styled.div`
  ...
  justify-content: flex-end;
  padding-right: 9%;
  padding-top: ${props => util.vhToPx(1.2)};
`
const RightTopText1 = styled.div`
  font-family: pamainregular;
  font-size: ${props => util.vhToPx(2.5)};
  color: #ffffff;
  text-transform: uppercase;
`
...
const WrapperRightBottom = styled.div`
  ...
  font-size: ${props => util.vhToPx(3.6)};
  text-transform: uppercase;
  padding-bottom: ${props => util.vhToPx(0.5)};
`
