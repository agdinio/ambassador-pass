...
const ArrowImg = styled.img`
  height: ${props => responsiveDimension(3.5)};
  width: ${props => responsiveDimension(3.5)};
...
const CoinIcon = styled.img`
  height: ${props => responsiveDimension(2.6)};
  width: ${props => responsiveDimension(2.6)};
  z-index: 1;
`

const Slider = styled.div`
  width: ${props => responsiveDimension(13)};
  min-width: ${props => responsiveDimension(13)};
  height: ${props => responsiveDimension(13)};
  min-height: ${props => responsiveDimension(13)};
  border-radius: 50%;
  display: flex;
  align-items: center;
  justify-content: center;
...
const SliderBorder = styled.div`
  ...
  min-height: ${props => responsiveDimension(13)};
  border-radius: 50%;
  border: ${responsiveDimension(1)} solid
    ${props => props.red || 'rgba(0, 0, 0, 0.3)'};
  display: flex;
  align-items: center;
  justify-content: center;
`
const SliderInner = styled.div`
  height: ${props => responsiveDimension(10.9)};
  min-height: ${props => responsiveDimension(10.9)};
  width: ${props => responsiveDimension(10.9)};
  min-width: ${props => responsiveDimension(10.9)};
  border-radius: 100%;
...
const RootDiv = styled.div`
  color: white;
  overflow: hidden;
  //max-width: ${props => responsiveDimension(96)};
  width: 100%;
  display: flex;
  position: relative;
  height: auto;
...
const Current = styled.div`
  ...
  min-width: ${props => responsiveDimension(11)};
  height: ${props => responsiveDimension(11)};
  min-height: ${props => responsiveDimension(11)};
  border-radius: 50%;
  text-align: center;
  //position: relative;
  display: flex;
...
const SlideWrapper = styled.div`
  display: flex;
  align-items: center;
  width: ${props => responsiveDimension(11 * props.count)};
  height: 100%;
  padding-top: 3%;
`
