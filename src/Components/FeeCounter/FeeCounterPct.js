...
@observer
export default class FeeCounterPct extends Component {
  constructor(props) {
    super(props)
...
const Slider = styled.div`
  ...
  overflow: hidden;
`
const SliderBorderORIG = styled.div`
  width: ${props => responsiveDimension(13)};
  height: ${props => responsiveDimension(13)};
  border-radius: 100%;
...
const SliderBorder = styled.div`
  ...
  justify-content: center;
`
const SliderInnerORIG = styled.div`
