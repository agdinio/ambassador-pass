...
export default class ShareThrough extends Component {
  ...
  render() {
    return (
      <Container>
        <MenuBanner
          backgroundColor={this.props.banner && this.props.banner.backgroundColor || '#19d1bf'}
          icon={this.props.banner && this.props.banner.icon || `menu-key-icon.svg`}
          iconBackgroundColor={this.props.banner && this.props.banner.iconBackgroundColor || '#000'}
          iconMaskColor={this.props.banner && this.props.banner.iconMaskColor || ''}
