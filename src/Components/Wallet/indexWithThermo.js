...
const KeyIcon = styled.div`
  ...
  border-radius: ${props => responsiveDimension(4)};
  border: ${props => responsiveDimension(0.2)} solid #19d1be;
  background-color: #000000;
  margin-left: ${props => responsiveDimension(0.2)};
  &:after {
    content: '';
    width: ${props => responsiveDimension(4)};
    height: ${props => responsiveDimension(4)};
...
const ProgressBarWrapper = styled.div`
  ...
  display: flex;
  justify-content: center;
  margin-top: ${props => responsiveDimension(7)};
`
...
const BottomHeader = styled.div`
  ...
  display: flex;
  justify-content: center;
  padding: 0 0 ${props => responsiveDimension(5)} 0;
`
...
const Divider = styled.div`
  width: 100%;
  height: ${props => responsiveDimension(0.3)};
