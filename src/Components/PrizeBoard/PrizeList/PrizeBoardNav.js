...
export default class PrizeBoardNav extends PureComponent {
  constructor(props) {
    super(props)
  ...
  animSubTitle() {
    const refSubTitle = this[`subtitle-${this.props.item.id}`]
    const refSubTitleNoWrap = this[`subtitle-nw-${this.props.item.id}`]
      ...
      return (
        <HeaderAbsolute>
          <HeaderTextWrapper>
            ...
            <HeaderTextSmall
              innerRef={ref => (this[`subtitle-${item.id}`] = ref)}
            >
              <HeaderTextSmallNowrap
                innerRef={ref => (this[`subtitle-nw-${item.id}`] = ref)}
              >
                {item.subTitle}
              </HeaderTextSmallNowrap>
            </HeaderTextSmall>
          ...
          <HeaderAbsolute>
            <HeaderLeft>
              <MenuMiddleIconWrapper>
                <Icon
                  src={
                    item.sponsorId.match(new RegExp('kcchiefs', 'gi'))
                      ? evalImage(
        ...
        return (
          <HeaderAbsolute>
            <InnerImageWrapper>
              <InnerImage
                src={evalImage(
                  `prizeboard/${item.id}-${item.inner.boardImage}`
                )}
              />
            </InnerImageWrapper>
            <HeaderTextWrapper>
