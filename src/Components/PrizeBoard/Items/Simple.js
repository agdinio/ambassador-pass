...
export default class Simple extends Component {
  render() {
    ...
    const isStar = 'sr' === menu.id.toLowerCase()

    return (
      <Container primary={menu.primaryBackgroundColor} onClick={refOnClick}>
        <Board secondary={menu.secondaryBackgroundColor}>
          ...
          <BoardDescImage
            src={evalImage(`prizeboard/${menu.id}-${menu.boardImage}`)}
          >
            <BoardDescImageMiddleIcon
              src={
                menu.sponsorId.match(new RegExp('kcchiefs', 'gi'))
