  ...
  handlePurchaseNowClick() {
    let comp = (
      <Payment
        ...
        timeStart={this.handleTimeStart.bind(this, 'PurchaseTokens-FillPaymentDetails')}
        timeStop={this.handleTimeStop.bind(this, 'PurchaseTokens-FillPaymentDetails')}
      />
    )
    this.props.NavigationStore.addSubScreen(comp, 'PurchaseTokens-Payment')
  }
