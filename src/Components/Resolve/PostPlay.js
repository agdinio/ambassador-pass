...
export default class PostPlay extends Component {
  constructor(props) {
    ...
    this.destroyShowPostPlay = intercept(
      this.props.ResolveStore,
      'showPostPlay',
      change => {
        this.showThis = change.newValue
        if (!this.animateOnce) {
      ...
      <TotalCommonWrapper>
        <TextWrapper>
          <Text
            ...
            letterSpacing={responsiveDimension(0.8)}
          >
            {correctAns}
          </Text>
          <Text
  ...
  prepareToHideThis() {
    setTimeout(() => {
      ...
      TweenMax.to(this.refSubTotalText, 0.3, {
        ...
        fontSize: responsiveDimension(6.5),
      })
...
const PostPlayFooterSlideUp = styled.div`
  ...
  //position: relative;
  //border-top: ${responsiveDimension(0.1)} solid #ffffff;
`
  ...
  return (
    ...
    >
      <Text
        font={'pamainregular'}
        size={2.5}
        letterSpacing={responsiveDimension(0.1)}
...
const PlayWrapper = styled.div`
  width: 50%;
  height: ${props => responsiveDimension(6.7)};
  border-top-right-radius: ${props => responsiveDimension(6.7)};
  border-bottom-right-radius: ${props => responsiveDimension(6.7)};
...
const PostTextWrapper = styled.div`
  width: 100%;
  height: ${props => responsiveDimension(6.2)};
  border-top-right-radius: ${props => responsiveDimension(6.2)};
  border-bottom-right-radius: ${props => responsiveDimension(6.2)};
  background-color: ${props => props.backgroundColor};
  display: flex;
  flex-direction: row;
  justify-content: flex-end;
...
const PostMultiplier = styled.div`
  width: ${props => responsiveDimension(6.2)};
  height: ${props => responsiveDimension(6.2)};
  border-radius: ${props => responsiveDimension(6.2)};
  display: flex;
  justify-content: center;
  align-items: center;
