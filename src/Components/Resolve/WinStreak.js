...
const Content = styled.div`
  ...
  align-items: center;
  //margin: ${props => responsiveDimension(1)} 0 ${props =>
  responsiveDimension(1)} 0;
`
...
const PointsAndTokensWrapper = styled.div`
  ...
  align-items: center;
  margin: ${props => responsiveDimension(3)} 0
    ${props => responsiveDimension(2)} 0;
`
...
const FooterSlideUp = styled.div`
  ...
  justify-content: space-between;
  position: relative;
  border-top: ${props => responsiveDimension(0.1)} solid #ffffff;
`
...
const QuadraFectaBigCircle = styled.div`
  ...
  height: ${props => responsiveDimension(23)};
  border-radius: ${props => responsiveDimension(23)};
...
const QuadraCircleOuter = styled.div`
  width: ${props => responsiveDimension(18)};
  height: ${props => responsiveDimension(18)};
  border-radius: ${props => responsiveDimension(18)};
...
const QuadraCircleInner = styled.div`
  ...
  border-radius: ${props => responsiveDimension(14)};
