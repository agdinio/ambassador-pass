...
export default class StarRedeem extends Component {
  ...
  handleAddStarClick(e) {
    ...
    const uid = `${this.itemPrize.shortName}-${this.itemPrize.seasonId}${
      this.itemPrize.boardTypeId
    }`
  ...
  evaluateData() {
    ...
    this.needMoreStars =
      this.props.StarBoardStore.localStars - 1 > 0 ? false : true
  }
  ...
  render() {
    ...
    const imageName = `starboard/${uid}_${this.itemPrize.images[0]}`
        ...
        <ContentScrolling>
          <Content>
            ...
            <Section marginTop={3} style={{ padding: '0 10% 0 10%' }}>
              <StarTypeImageWrap>
                <StarTypeImage src={evalImage(imageName) || DefaultIcon} />
                {/*
                <StarCounter
