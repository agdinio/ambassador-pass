...
const EarnerOuter = styled.div`
  width: 100%;
  border-top: ${props => responsiveDimension(0.15)} solid #414042;
`
...
const RankTab = styled.div`
  width: 23%;
  height: ${props => responsiveDimension(5.3)};
  border-top-right-radius: ${props => responsiveDimension(5.3)};
  border-bottom-right-radius: ${props => responsiveDimension(5.3)};
  display: flex;
  align-items: center;
