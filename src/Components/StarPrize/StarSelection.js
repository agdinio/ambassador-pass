    ...
    for (let i = 0; i < this.stars.length; i++) {
      if (key === i) {
        ...
        TweenMax.to(this[`starcircle-${key}`], 0.3, {
          border: `${responsiveDimension(0.5)} solid #eedf17`,
        })
        ...
        TweenMax.to(this[`starcircle-${i}`], 0.3, {
          border: `${responsiveDimension(0.5)} solid #59585b`,
        })
  ...
  render() {
    return (
      <Container innerRef={this.props.reference}>
        ...
        <Section height={45}>
          <SubSection style={{ marginTop: responsiveDimension(4) }}>
            <TextWrapper>
...
const StarsSection = styled.div`
  ...
  flex-direction: row;
  justify-content: center;
  // padding-left: ${props => responsiveDimension(7)};
  // padding-right: ${props => responsiveDimension(7)};
`
...
const StarWrapper = styled.div`
  ...
  // display: flex;
  // flex-direction: column;
  margin-left: ${props => responsiveDimension(props.index > 2 ? 3 : 1)};
  margin-right: ${props => responsiveDimension(props.index > 2 ? 3 : 1)};
`
...
const StarCircle = styled.div`
  ...
  border ${props => responsiveDimension(0.5)} solid #59585b;
`
...
const StarsmallNEW = styled.div`
  ...
  -webkit-mask-size: ${props =>
    `${responsiveDimension(5)}, ${responsiveDimension(5)}`};
  -webkit-mask-repeat: no-repeat;
  mask-image: url(${props => props.src});
  mask-size: ${props => `${responsiveDimension(5)}, ${responsiveDimension(5)}`};
