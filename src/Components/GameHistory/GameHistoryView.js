        ...
        <Scrolling>
          <Section direction="column" alignItems="center" marginTop="7">
            ...
            <InnerSection marginTop="1.5">
              <Text font="pamainbold" size="5.5" color={'#ffffff'} uppercase>{item.sportTypeName}</Text>
            </InnerSection>
          </Section>
              ...
              participants ? (
                <TeamsWrap>
                  <TeamIconWrapper>
                    ...
                    />
                    <TeamName color={participants[0].teamNameColor} marginLeft>{participants[0].name}</TeamName>
                  </TeamIconWrapper>

                  <TMVs>VS</TMVs>

                  <TeamIconWrapper>
                    <TeamName color={participants[1].teamNameColor} marginRight>{participants[1].name}</TeamName>
                    <TeamIcon
          ...
          <Section direction="column" alignItems="center" marginTop="5">
            <Text font="pamainregular" size="3.5" color={'#ffffff'} uppercase>your results summary</Text>
            {
              GameStore.isLoadingHistoryById ? (<ActivityIndicator height={7} color={'#ffffff'} />) : null
            }
          </Section>
