...
import iconEdit from '@/assets/images/input_feld-edit-profile.svg'
...
export default class Edit extends Component {
  ...
  handleInputChange(e) {
    this.props.ProfileStore.tempProfile[e.target.name] = e.target.value
  }
  ...
  handleSaveChangesClick() {
    ...
    ProfileStore.updateProfile({
      ...
      mobile: ProfileStore.tempProfile.mobile,
      notifyEmail: ProfileStore.tempProfile.notifyByEmail,
      notifyMobile: ProfileStore.tempProfile.mobile ? true : false,
      displayName: (ProfileStore.tempProfile.firstName || '') + ' ' + (ProfileStore.tempProfile.lastName || '')
    }).then(next => {
      if (next) {
          ...
          >
            {ProfileStore.tempProfile.isPhoneEditing ? (
              <FormInput
                ...
                name="mobile"
                type="text"
                value={ProfileStore.tempProfile.mobile}
                placeholder="PHONE"
                onChange={
                  ProfileStore.isUpdating
                    ? null
