...
class Login extends Component {
  ...
  setAttrs() {
    ...
    this.formInputAttr['borderRadius'] = vhToPx(0.7)

    this.textWrapperAttr['marginBottom'] = vhToPx(1.5)
    this.textSignInAttr['fontSize'] = vhToPx(5.5)
    this.textAmbAttr['fontSize'] = vhToPx(8)
  ...
  formSubmit() {
    ...
    if (phone || email) {
      ...
      this.props.AuthStore.login()
        .then(d => {
          d.currencies = this.props.ProfileStore.tempCurrencies
          ...
          this.props.ProfileStore.creditCurrencies({
            currency: 'points',
            amount: this.props.ProfileStore.tempCurrencies.points || 0,
          })
          this.props.ProfileStore.debitCurrenciesAtLaunch({
            currency: 'stars',
          ...
          this.props.ProfileStore.creditCurrencies({
            currency: 'stars',
            amount: this.props.ProfileStore.tempCurrencies.stars || 0,
          })
          this.props.ProfileStore.debitCurrenciesAtLaunch({
            currency: 'tokens',
          ...
          this.props.ProfileStore.creditCurrencies({
            currency: 'tokens',
            amount: this.props.ProfileStore.tempCurrencies.tokens || 0,
          })
...
const FormInput = styled.input`
  ...
  ${props =>
    props.valid === undefined
      ? ''
      : `color:#${props.valid ? '2fc12f' : 'ed1c24'};`} width: 100%;
  //margin-bottom: ${props => vhToPx(1.5)};
  margin-bottom: ${props => props.attr.marginBottom};
